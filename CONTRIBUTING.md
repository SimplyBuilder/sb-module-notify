### Contributing to `@jamilservices/sb-module-notify`
Thank you for considering contributing to `@jamilservices/sb-module-notify`!     
This document contains a set of guidelines for contributing to `@jamilservices/sb-module-notify`.      
